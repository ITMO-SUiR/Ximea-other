...
class Image(XI_IMG):
    ...
    def get_image_data_raw(self):
        ...
        the data.
        '''
        output_length = self.get_bytes_per_pixel()*self.width*self.height
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def get_ffc_flat_field_file_name(self):
        '''
        Set name of file to be applied for FFC processor.XI_PRM_FFC_FLAT_FIELD_FILE_NAME
        '''
        return self.get_param('ffc_flat_field_file_name')
    ...
    def get_ffc_dark_field_file_name(self):
        '''
        Set name of file to be applied for FFC processor.XI_PRM_FFC_DARK_FIELD_FILE_NAME
        '''
        return self.get_param('ffc_dark_field_file_name')
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def get_input_cms_profile(self):
        '''
        Filename for input cms profile (e.g. input.icc)XI_PRM_INPUT_CMS_PROFILE
        '''
        return self.get_param('input_cms_profile')
    ...
    def get_output_cms_profile(self):
        '''
        Filename for output cms profile (e.g. input.icc)XI_PRM_OUTPUT_CMS_PROFILE
        '''
        return self.get_param('output_cms_profile')
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def get_lens_comm_data(self):
        '''
        Write/Read data sequences to/from lensXI_PRM_LENS_COMM_DATA
        '''
        return self.get_param('lens_comm_data')
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def get_device_name(self):
        ...
        '''
        return self.get_param('device_name')

    def get_device_type(self):
        '''
        Return device typeXI_PRM_DEVICE_TYPE
        '''
        return self.get_param('device_type')
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def get_read_file_ffs(self):
        '''
        Read file from camera flash filesystem.XI_PRM_READ_FILE_FFS
        '''
        return self.get_param('read_file_ffs')

    def get_write_file_ffs(self):
        '''
        Write file to camera flash filesystem.XI_PRM_WRITE_FILE_FFS
        '''
        return self.get_param('write_file_ffs')
